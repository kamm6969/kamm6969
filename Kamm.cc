...
function library:New(name)
	...
	Menu.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
	...
	do
		...
		TextLabel.BorderColor3 = Color3.fromRGB(98, 13, 140)
		TextLabel.Position = UDim2.new(0, 1, 0.300000012, 0)
		TextLabel.Size = UDim2.new(0, 155, 0, 24)
		TextLabel.ZIndex = 2
		TextLabel.Font = Enum.Font.SourceSansSemibold
		TextLabel.Text = "keybinds"
		TextLabel.TextColor3 = Color3.fromRGB(98, 13, 140)
		TextLabel.TextSize = 14.000

		Frame.Parent = TextLabel
		Frame.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
	...
	TextLabel.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
	...
	TabButtons.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
	...
	Tabs.Name = "Tabs"
	Tabs.Parent = Menu
	Tabs.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
	...
	function menu:Tab(text)
		...
		TextButton.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
		...
		TabGui.Name = "TabGui"
		TabGui.Parent = Tabs
		TabGui.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
		...
		Left.Name = "Left"
		Left.Parent = TabGui
		Left.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
		...
		Right.Name = "Right"
		Right.Parent = TabGui
		Right.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
		...
		if first then
			TextButton.TextColor3 = Color3.fromRGB(98, 13, 140)
			currenttab = text
			TabGui.Visible = true
			first = false
		end
		...
		function Tab:MSector(text, side)
			...
			SectionText.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
			...
			sectiontabs.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
			...
			function MSector:Tab(text)
				...
				function tab:Element(type, text, data, callback)
					...
					if type == "Jumbobox" then
						...
						Dropdown.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
						...
						ImageLabel.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
						...
						TextLabel_3.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
					...
					elseif type == "ToggleKeybind" then
						...
						Toggle.Name = "Toggle"
						Toggle.Parent = tab1
						Toggle.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
						Toggle.BackgroundTransparency = 1.000
						Toggle.Size = UDim2.new(1, 0, 0, 15)

						Button.Name = "Button"
						Button.Parent = Toggle
						Button.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
					...
					elseif type == "ToggleColor" then
						...
						Colorpick.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
						...
						ColorDrag.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
						...
						Huepick.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
						...
						Huedrag.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
					...
					elseif type == "ToggleTrans" then
						...
						Transpick.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
						...
						Transcolor.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
						...
						Transdrag.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
					...
					elseif type == "Dropdown" then
						...
						Drop.AutomaticCanvasSize = "Y"
						Drop.ZIndex = 5
						Drop.ScrollBarImageColor3 = Color3.fromRGB(98, 13, 140)
						...
						for i,v in ipairs(data.options) do
							do
								...
								TextLabel.Parent = Button
								TextLabel.BackgroundColor3 = Color3.fromRGB(98, 13, 1401)
								TextLabel.BackgroundTransparency = 1.000
								TextLabel.BorderColor3 = Color3.fromRGB(53, 53, 53)
								TextLabel.Position = UDim2.new(0, 5, 0, -1)
								TextLabel.Size = UDim2.new(-0.21714285, 208, 1, 0)
					...
					elseif type == "Slider" then
						...
						Slider.Name = "Slider"
						Slider.Parent = tab1
						Slider.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
						...
						Value.Name = "Value"
						Value.Parent = Slider
						Value.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
		...
		function Tab:Sector(text, side)
			...
			SectionText.Font = Enum.Font.SourceSansSemibold
			SectionText.Text = text
			SectionText.TextColor3 = Color3.fromRGB(98, 13, 140)
			SectionText.TextSize = 15.000
			SectionText.TextXAlignment = Enum.TextXAlignment.Left
			...
			function Sector:Element(type, text, data, callback)
				...
				if type == "ScrollDrop" then
					...
					for i,v in ipairs(joe) do
						do
							...
							Scroll.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
				...
				elseif type == "TextBox" then
					...
					Box.Name = "Box"
					Box.Parent = Inner
					Box.BackgroundColor3 = Color3.fromRGB(98, 13, 140)
					...
					TextBox.TextColor3 = Color3.fromRGB(98, 13, 140)
...
local function AddLegit(Tab)
	...
	Tab:Element("Slider", "hitchance", {min = 1, max = 500, default = 500})
...
self:Element("ToggleColor", "self chams", {default = {Color = Color3.fromRGB(140,13,21)}}, function(tbl)
	if tbl.Toggle then
		for _,obj in pairs(SelfObj) do
			if obj.Parent ~= nil then
				obj.Material = Enum.Material.ForceField
...
world:Element("ToggleColor", "item esp", {default = {Color = Color3.fromRGB(98, 13, 140)}}, function(tbl)
...
client:Element("ToggleColor", "hitmarker", {default = {Color = Color3.fromRGB(140,13,21)}})
...
movement:Element("Slider", "speed", {min = 15, max = 500, default = 40})
...
chat:Element("Toggle", "chat spam", nil, function(tbl)
	if tbl.Toggle then
		while values.misc.chat["chat spam"].Toggle do
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "hi" or "Get Good Get Kamm.cc", false, "Innocent", false, true)
			wait(values.misc.chat["speed (ms)"].Slider/1000)
		end
	end
end)
chat:Element("Dropdown", "type", {options = {"standard", "Kamm.cc"}})
...
animations:Element("Dropdown", "animation", {options = {"floss", "default", "lil nas x", "dolphin", "monkey", "panini dance"}}, function(tbl)
	Dance.AnimationId = tbl.Dropdown == "floss" and "rbxassetid://5917459365" or tbl.Dropdown == "default" and "rbxassetid://3732699835" or tbl.Dropdown == "lil nas x" and "rbxassetid://5938396308" or tbl.Dropdown == "dolphin" and "rbxassetid://5938365243" or tbl.Dropdown == "monkey" and "rbxassetid://3716636630" or tbl.Dropdown == "panini dance" and "rbxassetid://5938396308"
...
do
	utility.default = {
		Line = {
			Thickness = 1.5,
			Color = Color3.fromRGB(98, 13, 140),
			Visible = false
		},
		Text = {
			Size = 13,
